    ...
    register(system: any, executionTime: ExecutionTime) {
        ...
        switch (executionTime) {
            ...
            case ExecutionTime.WINDOW_MOUSE_DOWN:
                ...
                this.world.canvas.addEventListener("pointerdown", system, false);
                break;
            case ExecutionTime.WINDOW_MOUSE_MOVE:
                this.systems[executionTime].push(system);
                this.world.canvas.addEventListener("pointermove", system, false);
                break;
            case ExecutionTime.WINDOW_MOUSE_UP:
                this.systems[executionTime].push(system);
                this.world.canvas.addEventListener("pointerup", system, false);
                break;
            case ExecutionTime.WINDOW_SCROLL:
                this.systems[executionTime].push(system);
                this.world.canvas.addEventListener("wheel", system, false);
                break;
